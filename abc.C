...
int abc( TString myMethodList = "" )
{
   ...
   TString fname = "./data4training.root";
   ...
   std::cout << "--- abc       : Using input file: " << input->GetName() << std::endl;
   ...
   TMVA::Factory *factory = new TMVA::Factory( "abc", outputFile,
   ...
   dataloader->AddVariable( "var0",                "Variable 0",  "units",'F' );
   dataloader->AddVariable( "var1",                "Variable 1",  "units", 'F' );
   dataloader->AddVariable( "var2",                "Variable 2", "units", 'F' );
   dataloader->AddVariable( "var3",                "Variable 3", "units", 'F' );
   dataloader->AddVariable( "var4",                "Variable 4", "units", 'F' );
   dataloader->AddVariable( "var5",                "Variable 5", "units", 'F' );
   dataloader->AddVariable( "var6",                "Variable 6", "units", 'F' );
   dataloader->AddVariable( "var7",                "Variable 7", "units", 'F' );
   dataloader->AddVariable( "var8",                "Variable 8", "units", 'F' );
   dataloader->AddVariable( "var9",                "Variable 9", "units", 'F' );
   dataloader->AddVariable( "var10",                "Variable 10",  "units", 'F' );
   dataloader->AddVariable( "var11",                "Variable 11",  "units", 'F' );
   dataloader->AddVariable( "var12",                "Variable 12", "units", 'F' );
   dataloader->AddVariable( "var13",                "Variable 13", "units", 'F' );
   dataloader->AddVariable( "var14",                "Variable 14", "units", 'F' );
   dataloader->AddVariable( "var15",                "Variable 15", "units", 'F' );
   dataloader->AddVariable( "var16",                "Variable 16", "units", 'F' );
   dataloader->AddVariable( "var17",                "Variable 17", "units", 'F' );
   dataloader->AddVariable( "var18",                "Variable 18", "units", 'F' );
   dataloader->AddVariable( "var19",                "Variable 19", "units", 'F' );
